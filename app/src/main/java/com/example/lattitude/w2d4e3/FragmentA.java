    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btSend.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = new Intent("message-receiver-A");
                intent.putExtra("message", etMessage.getText().toString());
                LocalBroadcastManager.getInstance(v.getContext()).sendBroadcast(intent);
            }
        });
        LocalBroadcastManager.getInstance(v.getContext()).registerReceiver(messageReceiverA,
                new IntentFilter("message-receiver-B"));
        return v;
    }

    private BroadcastReceiver messageReceiverA = new BroadcastReceiver() {
        @Override
